...
public class SearchQueryResolverTests
{
    ...
    [InlineData("Voiture Toyota", "vehicules", "voiture", null)]
    [InlineData("moto", "vehicules", "moto", null)]
    [InlineData("camion", "vehicules", "camion", null)]
    [InlineData("appartement", "immobilier", null, null)]
